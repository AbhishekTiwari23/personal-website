...
const Hero = () =>{
    return(
        <div className="hero">
            ...
            <p className = "greeting-text"> <span className="tex-left"> Hi <span className='grade'> Stranger </span><span className='wave'> 👋</span></span><br/> <div className='text-right'> I am <h2>{Abhishek.myname.firstName} <span className="grade">{Abhishek.myname.lastName}</span></h2></div></p>
